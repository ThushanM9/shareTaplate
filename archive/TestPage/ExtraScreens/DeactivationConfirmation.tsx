...
export const DeactivationConfirmation = () => {
  return (
      ...
      <DetailsBoxTemplate
        ...
        item={
          <div className=" pb-32">
            <InputContainer
              className=" mt-2"
              title="Account Deactivation User"
              input={
                <BasicInput
                  disabled={true}
            ...
            <InputContainer
              className=" mt-4"
              title="Account Deactivation Approval User"
              input={
                <BasicInput
                  disabled={true}
                  placeholder="Ted Russel"
            ...
            <InputContainer
              className=" mt-4"
              title="Account Deactivation Approval Date"
              input={<SelectDate disabled={false}></SelectDate>}
              label="This is automatically generated."
            />
              ...
              <div className="flex-1">
                ...
                <InputContainer
                  ...
                  input={
                    <BasicInput
                      disabled={true}
                      placeholder="Deactivation Charge"
                    ></BasicInput>
                  }
                  label="This is automatically generated."
                />
