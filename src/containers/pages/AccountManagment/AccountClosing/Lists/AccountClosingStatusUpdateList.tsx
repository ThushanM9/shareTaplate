...
import { ClosingStatusUpdateSchema } from "../Schemas/ClosingStatusUpdateSchema";

export const _AccountClosingStatusUpdateList = ({
  navigateToAccountView,
}: ReturnType<typeof mapState> & ReturnType<typeof mapDispatch>) => {
  const cardSchema = ClosingStatusUpdateSchema.steps![0].cards![0];
...
export const AccountClosingStatusUpdateList = connect(
  mapState,
  mapDispatch
)(_AccountClosingStatusUpdateList);
